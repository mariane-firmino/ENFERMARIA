        ...
        <div class="shadow p-3 mb-5 rounded">
            ...
            <div class="container text-justify">
                ...
                <div class="row g-4 mt-3">
                    ...
                    <div class="col-12 col-md-6">
                        <label for="pergunta7" class="form-label">
                            Você já teve a sua primeira menstruação? <sub>*</sub>
                        </label>
                    ...
                    <div class="col-12 col-md-6">
                        <label for="pergunta8" class="form-label">
                            Durante seu período menstrual, você sente cólicas? <sub>*</sub>
                        </label>
                ...
                <div class="row g-4 mt-2">
                    ...
                    <div class="col-12 col-md-6">
                        <label for="pergunta9" class="form-label">
                            Qual a intensidade das cólicas? <sub>*</sub>
                        </label>

                        <select class="form-select" id="pergunta9" name="pergunta9">
                            <option value="" selected disabled>Selecione uma opção</option>
                            <option value="feliz">0 - Nenhuma</option>
                            <option value="triste">1 - Leve</option>
                            <option value="indiferente">2 - </option>
                            <option value="indiferente">3 - </option>
                            <option value="indiferente">4 - </option>
                            <option value="indiferente">5 - Moderada</option>
                            <option value="indiferente">6 - </option>
                            <option value="indiferente">7 - </option>
                            <option value="indiferente">8 - </option>
                            <option value="indiferente">9 - </option>
                            <option value="indiferente">10 - Muito Intensa</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <label for="pergunta10" class="form-label">
                            Costuma tomar alguma medicação para cólicas? <sub>*</sub>
                        </label>
                ...
                <div class="row g-4 mt-2">
                    <!-- Pergunta 11 -->
                    <div class="col-12 col-md-6">
                        <label for="pergunta11" class="form-label">
                            Qual medicação você toma, quando está com cólicas? <sub>*</sub>
                        </label>
                        <input type="text" class="form-control" id="pergunta11" name="pergunta11">
                    </div>
                </div>
                ...
                <div class="row g-4 mt-2">
                    <!-- Pergunta 12 -->
                    <div class="col-12 col-md-6">
                        <label for="pergunta12" class="form-label">
                            Você possui vida sexual ativa? ou (Já teve a primeira relação sexual?) <sub>*</sub>
                        </label>
                        <select class="form-select" id="pergunta12" name="pergunta12">
                            <option value="" selected disabled>Selecione uma opção</option>
                            <option value="feliz">Sim</option>
                            <option value="triste">Não</option>
                        </select>
                    ...
                    <!-- Pergunta 13 -->
                    <div class="col-12 col-md-6">
                        <label for="pergunta13" class="form-label">
                            Usa algum método contraceptivo? (caso a resposta anterior seja SIM) <sub>*</sub>
                        </label>
                        <select class="form-select" id="pergunta13" name="pergunta13">
                            <option value="" selected disabled>Selecione uma opção</option>
                            <option value="feliz">Nenhum</option>
                            <option value="triste">Preservativo</option>
                            <option value="triste">Pílula</option>
                            <option value="triste">Injetável</option>
                            <option value="triste">DIU</option>
                            <option value="triste">Outro</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row g-4 mt-2">
                    <!-- Pergunta 14 -->
                    <div class="col-12 col-md-6">
                        <label for="pergunta14" class="form-label">
                            Por quê?
                            (caso a responsta anterior seja NÃO)
                        </label>

                        <select class="form-select" id="pergunta14" name="pergunta14">
                            <option value="" selected disabled>Selecione uma opção</option>
                    ...
                    <!-- Pergunta 15 -->
                    <div class="col-12 col-md-6">
                        <label for="pergunta15" class="form-label">
                            Você já foi em alguma consulta Ginecológica? <sub>*</sub>
                        </label>

                        <select class="form-select" id="pergunta15" name="pergunta15" required>
                            <option value="" selected disabled>Selecione uma opção</option>
                            <option value="feliz">Sim</option>
                            <option value="triste">Não</option>
                        </select>
